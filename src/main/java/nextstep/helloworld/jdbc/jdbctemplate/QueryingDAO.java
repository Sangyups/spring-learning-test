...
public class QueryingDAO {
    ...
    public Customer findCustomerById(Long id) {
        ...
        return jdbcTemplate.queryForObject(sql,
                (resultSet, rowNum) -> new Customer(resultSet.getLong("id"), resultSet.getString("first_name"),
    ...
    public List<Customer> findCustomerByFirstName(String firstName) {
        ...
        return jdbcTemplate.query(sql, ((rs, rowNum) -> new Customer(rs.getLong("id"), rs.getString("first_name"),
